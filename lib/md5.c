...
static void MD5Transform PROTO_LIST ((MD5_UINT4 [4], const unsigned char [64]));
static void Encode PROTO_LIST
       ((unsigned char *, MD5_UINT4 *, unsigned int)); 
static void Decode PROTO_LIST
       ((MD5_UINT4 *, const unsigned char *, unsigned int)); 
...
#define FF(a, b, c, d, x, s, ac) { (a) += F ((b), (c), (d)) + (x) + (MD5_UINT4)(ac); (a) = ROTATE_LEFT ((a), (s));        (a) += (b);        } 
#define GG(a, b, c, d, x, s, ac) {        (a) += G ((b), (c), (d)) + (x) + (MD5_UINT4)(ac);        (a) = ROTATE_LEFT ((a), (s));        (a) += (b);         } 
#define HH(a, b, c, d, x, s, ac) {        (a) += H ((b), (c), (d)) + (x) + (MD5_UINT4)(ac);        (a) = ROTATE_LEFT ((a), (s));        (a) += (b);        } 
#define II(a, b, c, d, x, s, ac) {        (a) += I ((b), (c), (d)) + (x) + (MD5_UINT4)(ac);        (a) = ROTATE_LEFT ((a), (s));        (a) += (b);        } 
...
unsigned int len;
{
       ...
       for (i = 0, j = 0; j < len; i++, j += 4) 
       output[i] = ((MD5_UINT4)input[j]) | (((MD5_UINT4)input[j+1]) << 8) | (((MD5_UINT4)input[j+2]) << 16)
